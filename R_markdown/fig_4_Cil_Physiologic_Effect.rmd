...
#write the plot
if(WRITE_PLOTS){ggsave(filename=here(figure_parts,title),plot=p, width=3.0, height=2.25,dpi=300,units="in")}#summary statistics for significant values formatted to place in the text of the paper
...
thisplot_bot_right_legend<-c(0.95,0.25)
p<-p+theme(legend.position = thisplot_bot_right_legend)
p
#write the plot
if(WRITE_PLOTS){ggsave(filename=here(figure_parts,title),plot=p, width=3.0, height=2.25,dpi=300,units="in")}
